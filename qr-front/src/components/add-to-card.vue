<template>
  <div @click="addToCard" class="text-nowrap primary-background flex items-center mt-2 justify-center gap-3 hover:border-white border border-transparent rounded-md text-center p-3 text-white text-sm">
