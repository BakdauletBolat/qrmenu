...
<div class="relative">
  ...
  <div class="px-4 fixed bottom-4 w-full ">
    <div @click="cardStorage.isActive.value = true"
       class="primary-background shadow-2xl max-w-[500px] mx-auto cursor-pointer flex gap-4 items-center rounded-lg w-full p-4 z-10" v-if="cardStorage.goods.value.length > 0">
    <div>
